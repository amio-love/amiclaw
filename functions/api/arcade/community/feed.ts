import { handleGetArcadeCommunityFeed } from '../../../../packages/api/src/handlers/arcade-community'
...
export async function onRequest(context: Context): Promise<Response> {
  ...
  if (request.method === 'GET') {
    return applyCorsHeaders(await handleGetArcadeCommunityFeed(request, env), corsHeaders)
  }
