...
export const feedItems: FeedItem[] = [
  {
    ...
    when: '12 分钟前',
    body: {
      text: '刚刚 00:48 拆完每日，AI 抢答密码盘的时候我都没看清符号 🙃',
      highlight: '00:48',
    },
    likes: 36,
    comments: 8,
...
export const communityPosts: CommunityPost[] = [
  ...
  },
  {
    ...
    initial: '夜',
    when: '1 小时前',
    body: '第一次进 Top 10！打完 AI 还安慰我说线路那段拆得很稳。',
    image: 'DEFUSED · 02:11',
    likes: 58,
    comments: 12,
  },
  ...
  },
  {
    ...
    initial: '南',
    when: '12 分钟前',
    body: '密码盘转过头，AI 居然冷静告诉我「再来一圈」。终极心理素质。',
    likes: 36,
    comments: 8,
  },
  {
    ...
    initial: '林',
    when: '3 小时前',
    body: '今天的每日比昨天难一档，前两次都被「键盘」卡住了。',
    image: 'EXPLODED · 03:14',
    likes: 14,
    comments: 3,
  },
  {
