/**
 * Pure client-side voice-activity detection (VAD) for a hands-free platform-ai
 * voice session (game-agnostic). Side-effect-free (no Web Audio, no React) so the
 * turn-boundary state machine is unit-testable by feeding it a sequence of frame
 * energies.
 *
